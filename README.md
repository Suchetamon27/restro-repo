...
* <img width="1893" height="870" alt="image" src="https://github.com/user-attachments/assets/00f7e0eb-58f7-4ce4-906b-7174a2d5fa69" />
...
1.  **Browse:** Scroll through the top brands or food grid.
2.  **Filter:** Use the Voice Mic or click the Veg/Non-Veg toggles.
3.  **Customize:** Click "Add" on a Burger or Pizza to select sizes and add-ons.
4.  **Gamify:** Click the **Spin Fab** (bottom left) to win a coupon code.
5.  **Ordering:** Go to cart, apply coupon `NEURO20` (or the one you won), add a tip, and checkout.
6.  **Tracking:** Watch the live drone/driver move on the map to your location.
7.  **Immersion:** Click the **Cloud Icon** in the navbar to enable Rain/Surge mode.
